...
app.post('/api/register', async (req, res) => {
    const { username, password, role } = req.body; // Thêm role vào request body
    ...
    try {
        ...
        const user = await User.create({ username, password: hashedPassword, role }); // Lưu role vào cơ sở dữ liệu
