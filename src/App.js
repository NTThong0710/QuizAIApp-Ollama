                        ...
                        <>
                            ...
                            {loading ? (
                                ...
                                <>
                                    ...
                                    (
                                    <button className="btn btn-primary mt-3" onClick={toggleChatbot} style={{position: 'fixed', bottom: '20px', right: '20px',}}>{showChatbot ? 'Đóng Chatbot' : 'Mở Chatbot'}</button>
                                    {showChatbot && isSubmitted &&<Chatbot />})
